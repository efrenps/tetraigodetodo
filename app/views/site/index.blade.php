...
<div class="row">
	<img src="img/temporal.jpg" class="img-responsive" alt="Responsive image">
</div>

<div class="row">
	<div class="col-md-3 col-xs-2"></div>
	<div class="col-md-6 col-xs-8">
		<h2>¡Sin embargo aun puedes cotizar tus productos con nosostros!</h2>
		<form role="form">
			...
			<div class="form-group">
				<label for="direccion">Link del producto</label>
				<input type="text" class="form-control" id="direccion" placeholder="Ingrese link del producto">
			</div>
			...
			<div class="form-group" style="max-width:60%;">
				...
				<input id="Precio" type="text" placeholder="Ingrese precio del producto" class="form-control">
			</div>
			...
			<button type="submit" class="btn btn-default">Solicitar Cotizacion</button>
		</form>
	</div>
	<div class="col-md-3 col-xs-2"></div>
</div>
